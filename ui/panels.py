...
class PriceInputPanel(QGroupBox):
    ...
    def _setup_ui(self) -> None:
        ...
        self.candle_time_label.setMinimumWidth(480)
...
class EWYResultPanel(ResultGroup):
    ...
    def _setup_ui(self) -> None:
        ...
        self.value_label = self._add_result_row("계약가치:", layout)
        self.margin_label = self._add_result_row("필요 증거금:", layout)
    ...
    def update_result(
        ...
        self.margin_label.setText(f"{margin_data['required_margin']:,.0f} KRW")
